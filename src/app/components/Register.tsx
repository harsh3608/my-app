    ...
    <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-md flex flex-col items-center mx-4">
      ...
      <form className="flex flex-col space-y-5 w-full">
        <input
          ...
          className="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-lg"
        />
        <input
          type="email"
          placeholder="Email"
        ...
        <Button
          type="submit"
          className="w-full bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold py-3 rounded-lg shadow-md hover:from-pink-600 hover:to-purple-500 transition-all duration-300 flex items-center justify-center gap-2 text-lg"
        >
      ...
      <div className="mt-6 text-gray-500 text-sm">
        ...
        <a href="/login" className="ml-2 text-purple-600 hover:underline font-medium">Sign in</a>
      </div>
    </div>
  </div>
);
